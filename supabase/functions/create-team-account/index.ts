  ...
  if (RESEND_API_KEY) {
    ...
    await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: EMAIL_FROM,
        to: email,
        subject: "You've been added to Uptown City Vibe's team",
        html: `<p>Hi ${full_name ?? ''},</p><p>An admin has set up a dashboard account for you at Uptown City Vibe, using this email and a password they'll share with you separately.</p><p>Please confirm whether you'd like to accept this:</p><p><a href="${link}">Review and respond</a></p>`,
      }),
    }).catch(() => {})
  }
